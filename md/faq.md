...
**Q:** 我可以为我的家设置传送点吗？  
**A:** 可以的，你可以使用 **/sethome** 命令设置家，使用 **/home** 命令回家，使用 **/delhome** 命令删除家，另外可以使用 **/homes** 查看你所有的家。注意，每位玩家最多可以设置 1 个家。详细见插件 [SimpleWarpForked](https://github.com/Bottle-M/SimpleWarpForked) 的介绍。  
